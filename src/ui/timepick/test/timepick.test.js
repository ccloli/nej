var f = function(){
    ...
    //开始单元测试
    test('timepick-ui',function(){
        stop();
        var _dp = _p._$$TimePick._$allocate({
...
test('define',function(){expect(0);
    define('{pro}timepick.test.js',['ui/timepick/timepick'],f);
});